...
let robot_moveGoal = require('./robot_moveGoal.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class robot_moveActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = robot_moveGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_moveActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = robot_moveGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new robot_moveGoal()
    }
...
module.exports = robot_moveActionGoal;
