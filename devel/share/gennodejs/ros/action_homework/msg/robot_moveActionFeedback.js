...
let robot_moveFeedback = require('./robot_moveFeedback.js');
let actionlib_msgs = _finder('actionlib_msgs');
let std_msgs = _finder('std_msgs');

//-----------------------------------------------------------

class robot_moveActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new robot_moveFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = robot_moveFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new robot_moveActionFeedback(null);
    ...
    data.feedback = robot_moveFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new robot_moveActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = robot_moveFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new robot_moveFeedback()
    }
...
module.exports = robot_moveActionFeedback;
