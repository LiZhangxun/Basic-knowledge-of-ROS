...
class Laser_distance {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Laser_distance(null);
  ...
  static datatype() {
    ...
    return 'delta_lidar/Laser_distance';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Laser_distance(null);
